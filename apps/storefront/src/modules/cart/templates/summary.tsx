...
const Summary = ({ cart }: SummaryProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <button className="mt-6 w-full rounded-base bg-cobalt py-3 text-body-sm font-medium uppercase tracking-[0.08em] text-chrome transition-colors hover:bg-cobalt-soft">
          Go to checkout
        </button>
      </LocalizedClientLink>
    </div>
