        ...
        <nav className="content-container flex items-center justify-between w-full h-full font-mono text-mono-sku uppercase tracking-[0.08em] text-chrome-dim">
          ...
          <div className="flex items-center gap-x-6 h-full flex-1 basis-0 justify-end">
            <div className="hidden small:flex items-center gap-x-6 h-full">
              <LocalizedClientLink
                className="flex h-full items-center transition-colors hover:text-cobalt-soft"
                href="/account"
            ...
            <Suspense
              fallback={
                <LocalizedClientLink
                  className="flex h-full items-center gap-2 transition-colors hover:text-cobalt-soft"
                  href="/cart"
